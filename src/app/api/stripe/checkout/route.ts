  ...
  try {
    const res = await fetch('https://api.stripe.com/v1/checkout/sessions', {
      ...
      body: new URLSearchParams({
        'mode': 'subscription',
        'success_url': `${req.headers.get('origin') || 'https://runbookhq.vercel.app'}/dashboard?billing=success`,
        'cancel_url': `${req.headers.get('origin') || 'https://runbookhq.vercel.app'}/signup?billing=cancelled`,
