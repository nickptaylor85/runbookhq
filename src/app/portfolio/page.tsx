    ...
    {loading ? <div style={{ textAlign: 'center', padding: 60, color: '#8a9ab8' }}>Loading portfolio...</div> : !data ? <div style={{ textAlign: 'center', padding: 60, color: '#f0405e' }}>Access denied. MSSP or superadmin role required.</div> : <>
      ...
      {tab === 'branding' && <div className="pf-section"><div className="pf-section-hd"><h2>🎨 White Label Branding</h2><p>Customise Watchtower with your brand for client-facing dashboards and reports</p></div>
        <div className="pf-brand-form">
          ...
          {branding.companyName && <div className="pf-brand-preview"><div className="pf-brand-preview-hd">Preview</div><div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: 12, background: '#0a0d14', borderRadius: 8, border: '1px solid #141820' }}><div style={{ width: 28, height: 28, borderRadius: 6, background: 'linear-gradient(135deg,' + (branding.primaryColor || '#3b8bff') + ',' + (branding.accentColor || '#7c6aff') + ')', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '.7rem', color: '#fff', fontWeight: 900 }}>{(branding.companyName || 'W').charAt(0)}</div><span style={{ fontWeight: 900, fontSize: '.95rem' }}>{branding.companyName}</span></div></div>}
...
.pf-hd{display:flex;align-items:center;padding:16px 0;border-bottom:1px solid #141820;gap:16px;flex-wrap:wrap}
...
.pf-tab{padding:6px 14px;border:1px solid #141820;border-radius:8px;background:transparent;color:#8a9ab8;font-size:.74rem;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;text-decoration:none;transition:all .2s}
...
.pf-kpi{background:linear-gradient(145deg,#0a0d14,#0f1219);border:1px solid #141820;border-radius:12px;padding:16px;text-align:center}
...
.pf-health-summary{display:flex;gap:16px;justify-content:center;margin-bottom:12px;padding:12px;background:linear-gradient(145deg,#0a0d14,#0f1219);border:1px solid #141820;border-radius:12px}
...
.pf-search{flex:1;padding:10px 14px;background:#0a0d14;border:1px solid #141820;border-radius:10px;color:#e6ecf8;font-size:.82rem;outline:none;font-family:'Inter',sans-serif}
.pf-search:focus{border-color:#3b8bff}
.pf-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:10px}
.pf-card{background:linear-gradient(145deg,#0a0d14,#0f1219);border:1px solid #141820;border-radius:14px;padding:16px}
...
.pf-stat{text-align:center;padding:6px;background:#050508;border-radius:6px;border:1px solid #141820}
...
.pf-btn{padding:7px 16px;border:1px solid #141820;border-radius:8px;background:transparent;color:#8a9ab8;font-size:.74rem;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;text-decoration:none;transition:all .2s}
...
.pf-corr-card{padding:14px 16px;background:linear-gradient(145deg,#0a0d14,#0f1219);border:1px solid #141820;border-radius:12px}
...
.pf-report-card{padding:14px 16px;background:linear-gradient(145deg,#0a0d14,#0f1219);border:1px solid #141820;border-radius:12px}
.pf-report-hd{display:flex;justify-content:space-between;align-items:center;margin-bottom:8px}
.pf-report-body{}
.toggle{position:relative;display:inline-block;width:36px;height:20px}
.toggle input{opacity:0;width:0;height:0}
.toggle-slider{position:absolute;cursor:pointer;inset:0;background:#141820;border-radius:10px;transition:.2s}
...
.pf-field input[type="text"],.pf-field input:not([type]){padding:8px 12px;background:#0a0d14;border:1px solid #141820;border-radius:8px;color:#e6ecf8;font-size:.78rem;outline:none;font-family:'Inter',sans-serif}
