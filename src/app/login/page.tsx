...
const CSS = `@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800;900&family=JetBrains+Mono:wght@600&display=swap');
...
.auth-field input{width:100%;padding:10px 14px;background:#10141e;border:1px solid #252e42;border-radius:10px;color:#e6ecf8;font-size:.85rem;font-family:'Outfit',sans-serif;outline:none;transition:border-color .2s}
