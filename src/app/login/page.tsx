    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#060a14]">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="text-center mb-8 animate-fade-up">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">SecOpsHQ</h1>
        ...
        <div className="animate-fade-up-d1">
          ...
          <p className="text-center text-sm text-[#4a5578] mt-5">Need access? Ask your administrator for an invite link.</p>
        </div>
        <div className="animate-fade-up-d2 text-center mt-8"><p className="text-xs text-[#2d3756] font-mono">SecOpsHQ v1.0</p></div>
      </div>
    </div>
  );
}
...
export default function LoginPage() {
  return <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#060a14]"><div className="w-6 h-6 border-2 border-white/20 border-t-white rounded-full animate-spin"/></div>}><LoginForm /></Suspense>;
}
