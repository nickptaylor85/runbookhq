...
export default function BrandedLoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#060c18', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif', color: '#e8ecf4', padding: '20px' }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <form onSubmit={handleLogin} style={{ background: '#0a0d18', border: '1px solid rgba(0,180,240,0.13)', borderRadius: 14, padding: '28px 24px' }}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="you@company.com"
              style={{ width: '100%', padding: '10px 12px', background: 'rgba(4,8,20,0.6)', border: `1px solid ${email ? accent + '60' : '#263044'}`, borderRadius: 8, color: '#e8ecf4', fontSize: '0.88rem', fontFamily: 'Inter, sans-serif', outline: 'none', boxSizing: 'border-box' }} />
          </div>
          <div style={{ marginBottom: 20 }}>
            ...
            <input type="password" value={password} onChange={e => setPassword(e.target.value)} required
              style={{ width: '100%', padding: '10px 12px', background: 'rgba(4,8,20,0.6)', border: `1px solid ${password ? accent + '60' : '#263044'}`, borderRadius: 8, color: '#e8ecf4', fontSize: '0.88rem', fontFamily: 'Inter, sans-serif', outline: 'none', boxSizing: 'border-box' }} />
          </div>
