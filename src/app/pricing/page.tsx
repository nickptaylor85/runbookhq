...
const FEATURE_TABLE = [
  ...
  ['Automation & response actions', '—', 'Yes', 'Yes', 'Yes'],
  ['Incidents + runbooks', '—', 'Yes', 'Yes', 'Yes'],
  ['RBAC & audit log', '—', 'Yes', 'Yes', 'Yes'],
  ['SLA tracking (MTTA/MTTR)', '—', 'Yes', 'Yes', 'Yes'],
  ['BYOK (your Anthropic key)', '—', 'Required', 'Required', 'Per-client'],
  ['Board reports + compliance', '—', '—', 'Yes', 'Yes'],
  ['API + webhooks + inbound push', '—', '—', 'Yes', 'Yes'],
  ['Multi-tenant managed clients', '—', '—', 'Up to 3', 'Unlimited'],
  ['IOC search + NL query', '—', '—', 'Yes', 'Yes'],
  ['White-label', '—', '—', '—', 'Yes'],
