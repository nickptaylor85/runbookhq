...
const PLANS = [
  {
    ...
    features: [
      ...
      'Full AI triage — APEX verdicts',
      'AI Co-Pilot — 5 queries/day',
      'Unlimited alert feed',
      '1 analyst seat',
      'Community support',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Unlimited AI Co-Pilot & agentic triage',
  ...
  },
  {
    ...
    features: [
      ...
      'PDF board reports & shareable links',
      'Compliance mapping — MITRE, NIS2, DORA',
      'API access, webhooks & inbound alerts',
      'Up to 3 managed tenants (+£199/client)',
      'IOC search across all connected tools',
  ...
  },
  {
    ...
    features: [
      ...
      'Dedicated MSSP portfolio dashboard',
      'OT / ICS add-on available',
      'SAML SSO & advanced RBAC',
      'SLA reporting — MTTA/MTTR analytics',
