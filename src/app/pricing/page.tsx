...
const PLANS = [
  ...
  { id: 'mssp', name: 'MSSP', price: 599, period: '/month', seats: 0, desc: 'For managed security providers', features: ['Everything in Business', 'Multi-tenant portfolio', 'Cross-client threat correlation', 'Automated client reports', 'White-label branding', '5 managed clients included', '+£49/additional client/mo'], cta: 'Start Free Trial', ctaStyle: 'primary' },
