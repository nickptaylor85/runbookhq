...
const PLANS = [
  ...
  { id: 'mssp', name: 'MSSP', price: 399, period: '/month', seats: 0, desc: 'For managed security providers', features: ['Everything in Business', 'Multi-tenant portfolio', 'Cross-client threat correlation', 'Automated client reports', 'White-label branding', '10 clients included', '+£29/additional client'], cta: 'Start Free Trial', ctaStyle: 'primary' },
