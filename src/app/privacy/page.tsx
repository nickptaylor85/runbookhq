      ...
      <div style={{maxWidth: 760, margin: '0 auto', padding: '48px 24px'}}>
        ...
        <div style={{height: 1, background: '#141820', marginBottom: 36}}/>
          ...
          <div style={{marginBottom: '28px'}}>
            ...
            <p style={{fontSize: '0.87rem', color: '#8a9ab0', lineHeight: '1.8'}}>You may delete your account and all associated data at any time via Settings → Account → Delete Account. For data requests or questions, contact us at privacy@getwatchtower.io.</p>
          </div>
          <div style={{marginBottom: '28px'}}>
          ...
          <div style={{marginBottom: '28px'}}>
            ...
            <p style={{fontSize: '0.87rem', color: '#8a9ab0', lineHeight: '1.8'}}>Watchtower Ltd · privacy@getwatchtower.io · Registered in England & Wales</p>
          </div>
