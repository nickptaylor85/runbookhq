...
function AttackChainGraph(){
  ...
  useEffect(()=>{fetch('/api/attack-chain').then(r=>r.ok?r.json():null).then(d=>{if(d)setData(d)}).catch(()=>{})},[]);
...
function PredictionsPanel(){
  ...
  useEffect(()=>{fetch('/api/predictions').then(r=>r.ok?r.json():null).then(d=>{if(d)setData(d)}).catch(()=>{})},[]);
...
function Vul(){
  ...
  useEffect(()=>{fetch('/api/tenable').then(r=>r.ok?r.json():null).then(d=>{if(d)setD(d)}).catch(()=>{})},[]);
