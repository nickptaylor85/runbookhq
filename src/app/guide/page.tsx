...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { heading: 'Plans at a glance', body: 'Community (£0) — 2 tools, read-only AI triage, 1 seat.\nEssentials (£149/seat/mo, min 2 seats) — unlimited tools, full AI Co-Pilot, automation, SLA tracking, BYOK.\nProfessional (£799/mo flat, up to 15 analysts) — everything in Essentials plus PDF reports, API, RBAC, compliance mapping, full audit trail.\nEnterprise/MSSP (£2,499/mo, unlimited analysts) — everything in Professional plus multi-tenant portfolio, white-label, per-client BYOK, cross-client AI threat correlation, branded client logins, dedicated account manager.\n\nAll paid plans require a BYOK Anthropic API key — AI costs go direct to your Anthropic account.' },
  ...
  },
  {
    ...
    items: [
      { heading: 'Enterprise / MSSP plan', body: 'The £2,499/mo plan includes unlimited analysts, unlimited client tenants, white-label branding, per-client BYOK isolation, cross-client AI threat correlation, automated weekly client reports, and branded login pages. Designed for MSSPs managing 5–50+ clients from one console.' },
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'TOTP / 2FA', body: 'Two-factor authentication via TOTP (Google Authenticator, Authy, etc.) is available for all accounts. Enable in Settings → Security. After enabling, every login requires the 6-digit code.' },
    ],
  },
  {
