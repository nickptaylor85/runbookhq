...
.wz-option{display:flex;align-items:center;gap:14px;padding:18px 22px;background:linear-gradient(145deg,#0b0f18,#10141e);border:1.5px solid #252e42;border-radius:16px;cursor:pointer;transition:all .25s;width:100%;color:#e6ecf8;font-family:'Inter',sans-serif}
...
.wz-tool{display:flex;flex-direction:column;align-items:center;gap:6px;padding:18px 12px;background:#0b0f18;border:1.5px solid #252e42;border-radius:14px;cursor:pointer;transition:all .2s;color:#8a9ab8;font-family:'Inter',sans-serif;position:relative}
...
.wz-btn{padding:12px 28px;border:none;border-radius:12px;background:linear-gradient(135deg,#3b8bff,#7c6aff);color:#fff;font-size:.88rem;font-weight:700;cursor:pointer;transition:all .25s;font-family:'Inter',sans-serif;box-shadow:0 4px 20px rgba(91,154,255,.3)}
...
.wz-btn-ghost{padding:12px 24px;border:1px solid #252e42;border-radius:12px;background:transparent;color:#8a9ab8;font-size:.82rem;font-weight:600;cursor:pointer;transition:all .2s;font-family:'Inter',sans-serif}
.wz-btn-ghost:hover{border-color:#3b8bff;color:#3b8bff}
.wz-skip{background:none;border:none;color:#50607a;font-size:.72rem;cursor:pointer;margin-top:20px;font-family:'Inter',sans-serif;transition:color .2s}
...
.wz-test-btn{padding:6px 14px;border:1px solid #3b8bff30;border-radius:8px;background:#3b8bff10;color:#3b8bff;font-size:.72rem;font-weight:600;cursor:pointer;transition:all .2s;font-family:'Inter',sans-serif;margin-top:4px}
