...
.wz-progress{width:100%;max-width:500px;height:3px;background:#1a2030;border-radius:3px;margin-bottom:48px;overflow:hidden}
.wz-bar{height:100%;background:linear-gradient(90deg,#3b8bff,#7c6aff);border-radius:3px;transition:width .4s ease}
...
.wz-sub{font-size:.88rem;color:#8a9ab8;margin-bottom:32px;line-height:1.6}
.wz-options{display:flex;flex-direction:column;gap:10px;text-align:left}
.wz-option{display:flex;align-items:center;gap:14px;padding:18px 22px;background:linear-gradient(145deg,#0b0f18,#10141e);border:1.5px solid #252e42;border-radius:16px;cursor:pointer;transition:all .25s;width:100%;color:#e6ecf8;font-family:'Outfit',sans-serif}
.wz-option:hover{border-color:#3b8bff;transform:translateX(4px);box-shadow:0 4px 20px rgba(91,154,255,.08)}
.wz-opt-icon{font-size:1.6rem;flex-shrink:0}
.wz-opt-title{font-size:.92rem;font-weight:700}
.wz-opt-desc{font-size:.72rem;color:#8a9ab8;margin-top:2px}
.wz-arrow{margin-left:auto;color:#3b8bff;font-size:1.2rem;transition:transform .2s}
.wz-option:hover .wz-arrow{transform:translateX(4px)}
.wz-hint{font-size:.68rem;color:#50607a;margin-top:20px}
.wz-tools{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:24px}
.wz-tool{display:flex;flex-direction:column;align-items:center;gap:6px;padding:18px 12px;background:#0b0f18;border:1.5px solid #252e42;border-radius:14px;cursor:pointer;transition:all .2s;color:#8a9ab8;font-family:'Outfit',sans-serif;position:relative}
.wz-tool:hover{border-color:#3b8bff40;color:#e6ecf8}
.wz-tool.selected{border-color:#3b8bff;background:#3b8bff08;color:#e6ecf8;box-shadow:0 0 16px rgba(91,154,255,.08)}
.wz-tool-icon{font-size:1.6rem}
.wz-tool-name{font-size:.72rem;font-weight:600}
.wz-check{position:absolute;top:6px;right:8px;color:#22c992;font-size:.72rem;font-weight:900}
.wz-actions{display:flex;justify-content:space-between;gap:12px}
.wz-btn{padding:12px 28px;border:none;border-radius:12px;background:linear-gradient(135deg,#3b8bff,#7c6aff);color:#fff;font-size:.88rem;font-weight:700;cursor:pointer;transition:all .25s;font-family:'Outfit',sans-serif;box-shadow:0 4px 20px rgba(91,154,255,.3)}
...
.wz-btn-ghost{padding:12px 24px;border:1px solid #252e42;border-radius:12px;background:transparent;color:#8a9ab8;font-size:.82rem;font-weight:600;cursor:pointer;transition:all .2s;font-family:'Outfit',sans-serif}
.wz-btn-ghost:hover{border-color:#3b8bff;color:#3b8bff}
.wz-skip{background:none;border:none;color:#50607a;font-size:.72rem;cursor:pointer;margin-top:20px;font-family:'Outfit',sans-serif;transition:color .2s}
.wz-skip:hover{color:#3b8bff}
.wz-cred-list{display:flex;flex-direction:column;gap:12px;text-align:left;margin-bottom:20px}
.wz-cred-card{background:linear-gradient(145deg,#0b0f18,#10141e);border:1px solid #252e42;border-radius:14px;padding:18px}
...
.wz-field label{display:block;font-size:.68rem;font-weight:600;color:#8a9ab8;margin-bottom:3px}
.wz-field input{width:100%;padding:9px 12px;background:#10141e;border:1px solid #252e42;border-radius:8px;color:#e6ecf8;font-size:.78rem;font-family:'JetBrains Mono',monospace;outline:none;transition:border .2s}
.wz-field input:focus{border-color:#3b8bff}
.wz-test-btn{padding:6px 14px;border:1px solid #3b8bff30;border-radius:8px;background:#3b8bff10;color:#3b8bff;font-size:.72rem;font-weight:600;cursor:pointer;transition:all .2s;font-family:'Outfit',sans-serif;margin-top:4px}
.wz-test-btn:hover{background:#3b8bff20}
...
.wz-done-card{display:flex;align-items:center;gap:8px;padding:12px 14px;background:linear-gradient(145deg,#0b0f18,#10141e);border:1px solid #1a2030;border-radius:12px;font-size:.76rem;font-weight:600}
