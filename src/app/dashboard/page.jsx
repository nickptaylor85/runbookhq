            ...
            <div style={{maxWidth:960,margin:'0 auto',width:'100%',display:'flex',flexDirection:'column',gap:14}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(5,1fr)',gap:8}} className='wt-five-col'>
                {[
                  ...
                  {val:critVulns, label:'Critical Vulns', color:'#8b6fff', sub:kevVulns.length>0?`${kevVulns.length} CISA KEV`:'High/Crit only', tab:'vulns', icon:'🔍'},
                        ...
                        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16}}>
                          <div>
                            ...
                            <div style={{display:'flex',gap:4,flexWrap:'wrap'}}>
                              {(vuln.affectedDevices||[vuln.device].filter(Boolean)).map(d=><span key={d} style={{fontSize:'0.58rem',padding:'2px 7px',borderRadius:3,background:'var(--wt-border)',color:'var(--wt-muted)',fontFamily:'JetBrains Mono,monospace'}}>{d}</span>)}
                            </div>
              ...
              <div style={{flex:1,overflowY:'auto',padding:'14px 16px',display:'flex',flexDirection:'column',gap:10}}>
                {copilotMessages.length===0 && (
                  <div style={{display:'flex',flexDirection:'column',gap:8,marginTop:8}}>
                    ...
                    {['Explain MITRE T1003.001 and how to detect it','Generate a Splunk query to hunt for lateral movement','What is the risk of CVE-2024-21413?','Summarise current incident INC-0847'].map(p=>(
