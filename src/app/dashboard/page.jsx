...
export default function DashboardPage() {
  ...
  const [intelFetchedAt, setIntelFetchedAt] = useState(null); // ISO timestamp of last live intel fetch
  ...
  const tenableNewsItems = DEMO_INTEL_BY_INDUSTRY['tenable_news'] || [];
                        ...
                        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16}}>
                          <div>
                            ...
                            <div style={{display:'flex',gap:4,flexWrap:'wrap'}}>
                              {(vuln.affectedAssets||vuln.affectedDevices||[vuln.device].filter(Boolean)).map(d=><span key={d} style={{fontSize:'0.58rem',padding:'2px 7px',borderRadius:3,background:'var(--wt-border)',color:'var(--wt-muted)',fontFamily:'JetBrains Mono,monospace'}}>{d}</span>)}
                            </div>
