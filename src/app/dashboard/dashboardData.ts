...
export const INDUSTRIES = ['Financial Services','Healthcare','Retail & eCommerce','Manufacturing','Energy & Utilities','Government & Public Sector','Legal & Professional','Technology','Education','Telecommunications'];
...
export const DEMO_GAP_DEVICES:GapDevice[] = [
...
export const DEMO_INTEL_BY_INDUSTRY:Record<string,IntelItem[]> = {
  'Financial Services':[
...
export const TENANT_ALERTS: {[k:string]: Alert[]} = {
  global: DEMO_ALERTS,
...
export const TENANT_VULNS: {[k:string]: Vuln[]} = {
  global: DEMO_VULNS,
...
export const TENANT_INCIDENTS: {[k:string]: Incident[]} = {
