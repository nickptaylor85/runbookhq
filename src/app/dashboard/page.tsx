...
const TL:any[]=[];
type Tab='overview'|'alerts'|'coverage'|'vulns'|'intel'|'tools';
...
function DashboardInner(){
  ...
  const[slaData,setSlaData]=useState<any>(null);const[incidents,setIncidents]=useState<any[]>([]);const[incidentModal,setIncidentModal]=useState<any>(null);const[customRunbooks,setCustomRunbooks]=useState<any[]>([]);
  ...
  const tabs:{k:Tab;l:string;i:string;badge?:number}[]=[{k:'overview',l:'Overview',i:'◉'},{k:'alerts',l:'Alerts',i:'⚡',badge:critCount},{k:'coverage',l:'Coverage',i:'🛡'},{k:'vulns',l:'Vulns',i:'🔓'},{k:'intel',l:'Intel',i:'🛡'},{k:'incidents',l:'Incidents',i:'📁'},{k:'runbooks',l:'Runbooks',i:'📋'},{k:'tools',l:`Tools (${enabledTools.length})`,i:'🔌'}];
