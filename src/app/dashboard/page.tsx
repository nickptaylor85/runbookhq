...
function ToolsManager({toolsData,onRefresh}:{toolsData:any;onRefresh:()=>void}){
  ...
  async function migrateTools(){setMigrating(true);try{await fetch('/api/admin/migrate',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({})});setTimeout(onRefresh,500)}catch{}setMigrating(false)}
