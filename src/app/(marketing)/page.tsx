...
export default function Landing() {
  return (<><style dangerouslySetInnerHTML={{ __html: CSS }} /><div className="ld">
    ...
    <section className="ld-pricing"><div className="ld-section-label" style={{textAlign:'center'}}>PRICING</div><h2 className="ld-h2c">Start free. Scale when ready.</h2><div className="ld-price-row"><div className="ld-price"><div className="ld-price-name">Community</div><div className="ld-price-val">£0</div><div className="ld-price-per">Free forever</div><div className="ld-price-feats">2 tools · Dashboard · Alerts · 1 seat</div><a href="/signup" className="ld-btn-ghost" style={{width:'100%',textAlign:'center',padding:'10px 0'}}>Get Started</a></div><div className="ld-price pop"><div className="ld-price-pop">Most Popular</div><div className="ld-price-name">Team</div><div className="ld-price-val">£29<span>/seat/mo</span></div><div className="ld-price-per">3 seats included</div><div className="ld-price-feats">Unlimited tools · AI triage · Co-Pilot · Runbooks · Threat intel · SLA tracking · TV Wall</div><a href="/signup?plan=team" className="ld-btn" style={{width:'100%',textAlign:'center',padding:'10px 0'}}>Start Free Trial →</a></div><div className="ld-price"><div className="ld-price-name">Business</div><div className="ld-price-val">£79<span>/month</span></div><div className="ld-price-per">10 seats included</div><div className="ld-price-feats">Everything in Team · Compliance · Reports · API · RBAC</div><a href="/signup?plan=business" className="ld-btn-ghost" style={{width:'100%',textAlign:'center',padding:'10px 0'}}>Start Free Trial →</a></div><div className="ld-price"><div className="ld-price-name">MSSP</div><div className="ld-price-val">£399<span>/month</span></div><div className="ld-price-per">10 clients included · +£29/client</div><div className="ld-price-feats">Everything in Business · Portfolio · Correlation · Auto reports · White-label</div><a href="/signup?plan=mssp" className="ld-btn-ghost" style={{width:'100%',textAlign:'center',padding:'10px 0'}}>Start Free Trial →</a></div></div><div className="ld-price-link"><a href="/pricing">View full pricing with add-ons →</a></div></section>
