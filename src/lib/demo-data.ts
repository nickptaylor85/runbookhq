...
export const DEMO_DEFENDER_ALERTS = [
  ...
  { id: 'cs-001', title: 'Falcon: Malicious PowerShell execution blocked', severity: 'high', status: 'new', source: 'CrowdStrike', category: 'Execution', device: 'WS055.corp.local', user: 'bturner', timestamp: new Date(Date.now() - 2100000).toISOString(), mitre: 'T1059.001' },
  { id: 'cs-002', title: 'Falcon: Credential theft via Mimikatz', severity: 'critical', status: 'new', source: 'CrowdStrike', category: 'Credential Access', device: 'SRV-APP01', user: 'admin_svc', timestamp: new Date(Date.now() - 4200000).toISOString(), mitre: 'T1003.001' },
  { id: 's1-001', title: 'SentinelOne: Ransomware behavior detected and rolled back', severity: 'critical', status: 'resolved', source: 'SentinelOne', category: 'Impact', device: 'WS066.corp.local', user: 'rsmith', timestamp: new Date(Date.now() - 3000000).toISOString(), mitre: 'T1486' },
  { id: 'cx-001', title: 'Cortex XDR: Suspicious process injection chain', severity: 'high', status: 'investigating', source: 'Cortex XDR', category: 'Defense Evasion', device: 'WS022.corp.local', user: 'jlee', timestamp: new Date(Date.now() - 5000000).toISOString(), mitre: 'T1055' },
  { id: 'sp-001', title: 'Splunk: Anomalous VPN login from unusual geolocation', severity: 'medium', status: 'new', source: 'Splunk', category: 'Initial Access', device: 'VPN-GW-01', user: 'cdavis', timestamp: new Date(Date.now() - 6000000).toISOString(), mitre: 'T1078' },
  { id: 'sn-001', title: 'Sentinel: Mass mail forwarding rule created', severity: 'high', status: 'new', source: 'Sentinel', category: 'Collection', device: 'EXO-CLOUD', user: 'mwilson', timestamp: new Date(Date.now() - 3500000).toISOString(), mitre: 'T1114.003' },
  { id: 'dt-001', title: 'Darktrace: Unusual outbound data transfer — 3.2GB to external IP', severity: 'high', status: 'new', source: 'Darktrace', category: 'Exfiltration', device: 'SRV-FILE02', user: '', timestamp: new Date(Date.now() - 2800000).toISOString(), mitre: 'T1048' },
  { id: 'cb-001', title: 'Carbon Black: Living-off-the-land binary execution (LOLBin)', severity: 'medium', status: 'new', source: 'Carbon Black', category: 'Execution', device: 'WS033.corp.local', user: 'contractor-ext', timestamp: new Date(Date.now() - 7200000).toISOString(), mitre: 'T1218' },
  { id: 'wiz-001', title: 'Wiz: Publicly exposed S3 bucket with PII data', severity: 'critical', status: 'new', source: 'Wiz', category: 'Cloud Misconfiguration', device: 'aws:s3:customer-data-prod', user: '', timestamp: new Date(Date.now() - 1500000).toISOString(), mitre: '' },
  { id: 'pp-001', title: 'Proofpoint: Executive impersonation phishing campaign (12 targets)', severity: 'high', status: 'new', source: 'Proofpoint', category: 'Initial Access', device: 'MAIL-GW', user: 'ceo-group', timestamp: new Date(Date.now() - 4500000).toISOString(), mitre: 'T1566.001' },
